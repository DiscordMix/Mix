...
namespace Core {
    ...
    export class Bot<TState = any, TActionType = any> extends EventEmitter implements IBot<TState, TActionType> {
         ...
         */
        public readonly services: Services.ServiceManager;
         ...
         */
        public readonly tasks: Tasks.TaskManager;
         ...
         */
        public readonly optimizer: Optimization.Optimizer;
